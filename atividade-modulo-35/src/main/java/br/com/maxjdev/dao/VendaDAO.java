...
import br.com.maxjdev.dao.factory.ProdutoQuantidadeFactory;
import br.com.maxjdev.dao.factory.VendasFactory;
...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
    ...
    @Override
    public Venda consultar(Serializable valor) throws DAOException {
...
//		return venda;
        ...
        try {
            ...
            rs = stm.executeQuery();
            if (rs.next()) {
                Venda venda = VendasFactory.convert(rs);
    ...
    @Override
    public Boolean cadastrar(IPersistente entity) throws DAOException {
        Connection connection = null;
        PreparedStatement stm = null;
        try {
            connection = getConnection();
